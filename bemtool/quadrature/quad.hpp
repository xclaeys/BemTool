...
public:
  ...
  friend const vector<R1>&   points (const QuadFEM<1>& qr){return qr.x;}
  friend const vector<Real>& weights(const QuadFEM<1>& qr){return qr.dx;}
...
public:
  ...
  friend const vector<R2>&   points (const QuadFEM<2>& qr){return qr.x;}
  friend const vector<Real>& weights(const QuadFEM<2>& qr){return qr.dx;}
